...
{
       0,    88,    88,    90,    92,    98,   104,   109,   117,   126,
     130
};
#endif
...
{
  "$end", "error", "$undefined", "B", "'+'", "'*'", "'\\n'", "$accept",
  "list", "stat", "R", "N", YY_NULLPTR
};
#endif
...
{
       2,     3,     8,     4,     9,    10,    11,    13,    14,    12,
       4,     0,     0,    11
};

static const yytype_int8 yycheck[] =
{
       0,     1,     6,     3,     6,     4,     5,    10,    11,     3,
       3,    -1,    -1,     5
};
...
#line 1292 "y.tab.c" /* yacc.c:1646  */
  ...
  case 7:
#line 110 "ass8.y" /* yacc.c:1646  */
    {
	printf("Reached R*N,N=%d\n",(yyvsp[0]));
	n1=(toDecimal((yyvsp[-2])));
	n2=(toDecimal((yyvsp[0])));
	  (yyval)=n1 * n2;
	ArrayGraph("*",n1,n2);
	}
